...
If you are working on new features or refactoring [create a proposal](https://github.com/bitExpert/composer-phive-bridge/issues).
...
```console
$ git clone git@github.com:bitExpert/composer-phive-bridge.git
$ cd composer-phive-bridge
```
...
2. Fork the repository (https://github.com/bitExpert/composer-phive-bridge)
...
```console
$ git remote add {username} git@github.com:{username}/composer-phive-bridge.git
$ git fetch {username}
```
...
To ssh://git@github.com/{username}/composer-phive-bridge.git
